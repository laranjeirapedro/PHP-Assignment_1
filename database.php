...
class database{
  ...
  public function updateRecord($postData)
  {
    ...
    $subject = $this->con->real_escape_string($_POST['usubject']);
    $assignment = $this->con->real_escape_string($_POST['uassignment']);
    $grade = $this->con->real_escape_string($_POST['ugrade']);
